...
abstract class BaseCcFilesPeer {
	...
	/** the column name for the CRTC field */
	const CRTC = 'cc_files.CRTC';	
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(CcFilesPeer::CRTC);
		} else {
			...
			$criteria->addSelectColumn($alias . '.CRTC');
		}
	}
